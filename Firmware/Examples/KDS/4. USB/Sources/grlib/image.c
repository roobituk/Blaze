...
//
//*****************************************************************************
static uint8_t g_pucDictionary[32];
...
//*****************************************************************************
static void
PixelTransparentDraw(const tContext *pContext, int32_t lX, int32_t lY,
                     ...
                     uint32_t ulTransparent)
{
    ...
    switch(lBPP)
    {
        ...
        case 4:
        {
            ...
            bSkip = (ucPixel == (uint8_t)ulTransparent) ? true : false;
            lStart = 0;
            lStartX0 = lX0;
            lBit = lX0;
            lLen = bSkip ? 0 : 1;
            ...
            for(lIndex = 1; lIndex < lCount; lIndex++)
            {
                ...
                //
                if(ucPixel != (uint8_t)ulTransparent)
                {
                    //
        ...
        case 8:
        {
            ...
            // Are we starting by drawing or skipping pixels?
            //
            bSkip = (pucData[0] == (uint8_t)ulTransparent) ? true : false;
            lStart = 0;
            lLen = bSkip ? 0 : 1;
            ...
            for(lIndex = 1; lIndex < lCount; lIndex++)
            {
                ...
                // Is this pixel a transparent one?
                //
                if(pucData[lIndex] != (uint8_t)ulTransparent)
                {
                    //
                    // It's not transparent.  Have we just ended a run of
                    // transparent pixels?
...
//*****************************************************************************
static void
InternalImageDraw(const tContext *pContext, const uint8_t *pucImage,
                  int32_t lX, int32_t lY, uint32_t ulTransparent,
...
//*****************************************************************************
void
GrTransparentImageDraw(const tContext *pContext, const uint8_t *pucImage,
                       int32_t lX, int32_t lY, uint32_t ulTransparent)
{
...
//*****************************************************************************
void
GrImageDraw(const tContext *pContext, const uint8_t *pucImage,

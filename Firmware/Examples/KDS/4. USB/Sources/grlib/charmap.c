...
//
//*****************************************************************************
const uint16_t g_pusISO8859_2_Unicode[] =
{
...
//
//*****************************************************************************
const uint16_t g_pusISO8859_3_Unicode[] =
{
...
//
//*****************************************************************************
const uint16_t g_pusISO8859_4_Unicode[] =
{
...
//
//*****************************************************************************
const uint16_t g_pusISO8859_7_Unicode[] =
{
...
//
//*****************************************************************************
const uint16_t g_pusISO8859_10_Unicode[] =
{
...
//
//*****************************************************************************
const uint16_t g_pusISO8859_13_Unicode[] =
{
...
//
//*****************************************************************************
const uint16_t g_pusISO8859_14_Unicode[] =
{
...
//
//*****************************************************************************
const uint16_t g_pusISO8859_16_Unicode[] =
{
...
//
//*****************************************************************************
const uint16_t g_pusWIN1250_Unicode[] =
{
...
//
//*****************************************************************************
const uint16_t g_pusWIN1251_Unicode[] =
{
...
//
//*****************************************************************************
const uint16_t g_pusWIN1252_Unicode[] =
{
...
//
//*****************************************************************************
const uint16_t g_pusWIN1253_Unicode[] =
{
...
//
//*****************************************************************************
const uint16_t g_pusWIN1254_Unicode[] =
{
    0x20AC,      0, 0x201A, 0x0192, 0x201E, 0x2026, 0x2020, 0x2021,
                       ...
                       uint32_t *pulSkip)
{
    ...
    *pulSkip = 1;
    ...
    else
    {
        ...
        // table.
        //
        return(g_pusISO8859_7_Unicode[(uint8_t)*pcSrcChar - 0xA1]);
    }
}
                  ...
                  uint32_t *pulSkip)
{
    ...
    //
    while(ulCount && ((uint8_t)pcSrcChar[ulIndex] & 0xC0) == 0x80)
    {
          //
           // Skip the byte.
           //
    ...
    //
    if(!((uint8_t)(pcSrcChar[ulIndex]) & 0x80))
    {
        //
        // Yes - the Unicode equivalent is just the bottom 7 bits of the
        // UTF-8 byte.
        //
        ulUnicode = (uint8_t)(pcSrcChar[ulIndex++]) & 0x7F;
        ulToRead = 0;
    }
    else
    {
        ...
        else
        {
            ...
            //
            ulUnicode = (uint8_t)pcSrcChar[ulIndex++] &
                        ((1 << (6 - ulToRead)) - 1);
            ...
            while(ulCount && ulToRead)
            {
                ...
                //
                if(((uint8_t)pcSrcChar[ulIndex] & 0xC0) != 0x80)
                {
                    //
                ...
                else
                {
                    ...
                    ulUnicode = ((ulUnicode << 6) |
                                 ((uint8_t)pcSrcChar[ulIndex++] & 0x3F));
                    ulToRead--;
                    ulCount--;
                }
            }
...
GrMapUTF16_Unicode(const char *pcSrcChar, uint32_t ulCount,
                   uint32_t *pulSkip, uint8_t bLE)
{
    uint16_t usChar, usCharToo;
    uint32_t ulCode;
    const char *pcChar;
    ...
    // found one.
    //
    *pulSkip = (uint32_t)(pcChar - pcSrcChar);
    return(ulCode);
}

...
//*****************************************************************************
static uint32_t
GrOffScreen4BPPColorTranslate(void *pvDisplayData, uint32_t ulValue)
{
...
//*****************************************************************************
static void
GrOffScreen4BPPPixelDraw(void *pvDisplayData, int32_t lX, int32_t lY,
                         uint32_t ulValue)
{
...
//*****************************************************************************
static void
GrOffScreen4BPPPixelDrawMultiple(void *pvDisplayData, int32_t lX, int32_t lY,
...
//*****************************************************************************
static void
GrOffScreen4BPPLineDrawH(void *pvDisplayData, int32_t lX1, int32_t lX2, int32_t lY,
                         uint32_t ulValue)
{
    unsigned char *pucData;
    long lBytesPerRow;
...
//*****************************************************************************
static void
GrOffScreen4BPPLineDrawV(void *pvDisplayData, int32_t lX, int32_t lY1, int32_t lY2,
                         uint32_t ulValue)
{
    unsigned char *pucData;
    long lBytesPerRow;
...
//*****************************************************************************
void
GrOffScreen4BPPInit(tDisplay *pDisplay, uint8_t *pucImage, int32_t lWidth,
                    int32_t lHeight)
{
    //
    // Check the arguments.
...
//*****************************************************************************
void
GrOffScreen4BPPPaletteSet(tDisplay *pDisplay, uint32_t *pulPalette,
                          uint32_t ulOffset, uint32_t ulCount)
{
    unsigned char *pucData;

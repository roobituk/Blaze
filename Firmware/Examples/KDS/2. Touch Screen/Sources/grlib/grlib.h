...
typedef struct
{
    ...
    //
    void (*pfnPixelDraw)(void *pvDisplayData, int32_t lX, int32_t lY,
                         uint32_t ulValue);

    //
    //! A pointer to the function to draw multiple pixels on this display.
    //
    void (*pfnPixelDrawMultiple)(void *pvDisplayData, int32_t lX, int32_t lY,
                                 int32_t lX0, int32_t lCount, int32_t lBPP,
    ...
    //
    void (*pfnLineDrawH)(void *pvDisplayData, int32_t lX1, int32_t lX2, int32_t lY,
                         uint32_t ulValue);

    //
    //! A pointer to the function to draw a vertical line on this display.
    //
    void (*pfnLineDrawV)(void *pvDisplayData, int32_t lX, int32_t lY1, int32_t lY2,
                         uint32_t ulValue);
...
typedef struct
{
    ...
    //
    void (*pfnFontInfoGet)(uint8_t *pucFontId, uint8_t *pucFormat,
                           uint8_t *pucWidth, uint8_t *pucHeight,
                           uint8_t *pucBaseline);
    ...
    //
    const uint8_t *(*pfnFontGlyphDataGet)(uint8_t *pucFontId,
...
//
//*****************************************************************************
typedef void (*tStringRenderer)(const struct _tContext *, const char *, int32_t, int32_t,
                                int32_t, uint32_t);
...
extern const tFontEx g_sFontExArial16;
#define FontArial_16pt (const tFont *)&g_sFontExArial16

extern const tFontEx g_sFontExOrbitron12;
#define FontOrbitron_12pt (const tFont *)&g_sFontExOrbitron12
extern const tFontEx g_sFontExOrbitron16;
#define FontOrbitron_16pt (const tFont *)&g_sFontExOrbitron16
extern const tFontEx g_sFontExOrbitron24;
#define FontOrbitron_24pt (const tFont *)&g_sFontExOrbitron24

extern const tFontEx g_sFontExOrbitronb12;
#define FontOrbitron_12pt_Bold (const tFont *)&g_sFontExOrbitronb12
extern const tFontEx g_sFontExOrbitronb16;
#define FontOrbitron_16pt_Bold (const tFont *)&g_sFontExOrbitronb16
extern const tFontEx g_sFontExOrbitronb24;
#define FontOrbitron_24pt_Bold (const tFont *)&g_sFontExOrbitronb24
extern const tFontEx g_sFontExOrbitronb48;
#define FontOrbitron_48pt_Bold (const tFont *)&g_sFontExOrbitronb48
extern const tFontEx g_sFontExOrbitronb32;
#define FontOrbitron_32pt_Bold (const tFont *)&g_sFontExOrbitronb32
extern const tFontEx g_sFontExOrbitronb72;
#define FontOrbitron_72pt_Bold (const tFont *)&g_sFontExOrbitronb72			
...
extern void GrImageDraw(const tContext *pContext,
                        const uint8_t *pucImage, int32_t lX, int32_t lY);
...
extern void GrOffScreen1BPPInit(tDisplay *pDisplay, uint8_t *pucImage,
                                int32_t lWidth, int32_t lHeight);
extern void GrOffScreen4BPPInit(tDisplay *pDisplay, uint8_t *pucImage,
                                int32_t lWidth, int32_t lHeight);
extern void GrOffScreen4BPPPaletteSet(tDisplay *pDisplay,
                                      uint32_t *pulPalette,
                                      uint32_t ulOffset,
                                      uint32_t ulCount);
extern void GrOffScreen8BPPInit(tDisplay *pDisplay, uint8_t *pucImage,
                                int32_t lWidth, int32_t lHeight);
...
uint32_t GrStringLanguageSet(uint16_t usLangID);
uint32_t GrStringGet(int32_t lIndex, char *pcData, uint32_t ulSize);
...
//
//*****************************************************************************
extern void GrFontInfoGet(const tFont *pFont, uint8_t *pucFormat,
                          uint8_t *pucMaxWidth, uint8_t *pucHeight,
                          uint8_t *pucBaseline);
...
extern const uint8_t *GrFontGlyphDataGet(const tFont *pFont,
                                               uint32_t ulCodePoint,
                                               uint8_t *pucWidth);
extern uint16_t GrFontCodepageGet(const tFont *pFont);
extern uint16_t GrFontNumBlocksGet(const tFont *pFont);
...
//
//*****************************************************************************
void GrFontGlyphRender(const tContext *pContext, const uint8_t *pucData,
                       int32_t lX, int32_t lY, uint32_t bCompressed,
                       uint32_t bOpaque);
void
GrDefaultStringRenderer(const tContext *pContext, const char *pcString,
                        int32_t lLength, int32_t lX, int32_t lY, uint32_t bOpaque);
...
extern void GrCodepageMapTableSet(tContext *pContext,
                                  tCodePointMap *pCodePointMapTable,
                                  uint8_t ucNumMaps);
extern int32_t GrStringCodepageSet(tContext *pContext,
                                uint16_t usCodepage);
